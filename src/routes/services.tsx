  ...
  head: () => ({
    meta: [
      { title: "Services — Ardivia" },
      {
        name: "description",
        content:
          "Integrated design and build services: bespoke residential, commercial interiors, project management, materials sourcing and heritage renovation.",
      },
      { property: "og:title", content: "Services — Ardivia" },
      {
        property: "og:description",
        content: "Six pillars of an integrated design-and-build practice.",
      },
    ],
  }),
...
const services = [
  ...
  },
  {
    ...
    desc: "Environments that communicate brand values with spatial intelligence — offices, hospitality, and considered retail experiences.",
    features: [
      "Workplace design",
      "Hospitality interiors",
      "Retail environments",
      "Brand-led specification",
    ],
  },
  {
    num: "03",
  ...
  },
  {
    ...
    features: [
      "Vetted principal contractors",
      "Specialist trades",
      "European artisan network",
    ...
    <main>
      <section className="arch-hero">
        <div className="arch-hero-left">
          ...
          <p className="hero-sub">
            An integrated practice — one studio responsible for the entire journey, from first
            sketch to the moment we hand you the key.
          </p>
      ...
      <section className="services">
        <div className="services-header">
          ...
          <p className="services-intro reveal d2">
            Every commission draws on the full breadth of the practice. You retain a single point of
            accountability — and a single creative vision — across every phase.
          </p>
        </div>
      ...
      <section className="testimonial">
        <p className="testi-quote reveal">
          "What sets Ardivia apart is the complete absence of drama. Every problem was resolved
          before it reached us. We moved in on time, on budget, and fell completely in love with the
          result."
        </p>
