  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Clients & Testimonials — Ardivia" },
      {
        ...
        content: "Built on trust. Relationships that outlast the project.",
      },
      {
        property: "og:image",
...
const repeats = [
  {
    ...
    name: "The Rothbury Family",
    projects:
      "Richmond townhouse (2019) · Surrey country home (2021) · Kensington pied-à-terre (2024)",
  },
  {
    num: "2×",
    name: "Marcus Gillespie",
      ...
      <section className="section-pad bg-linen">
        ...
        >
          ...
          >
            ...
            communication, and the courage to say no when a project isn't right for us or a client
            isn't right for the project.
          </p>
        </div>
