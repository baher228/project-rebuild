...
export const metadata: Metadata = {
  ...
  description: "London design-and-build studio crafting exceptional residences, commercial interiors and heritage renovations.",
  openGraph: {
      ...
      <section className="projects">
        ...
        <div className="projects-grid">
          {projects.map((project, index) => (
            <Link href="/projects" key={project.name} className={`project-card reveal${index ? ` d${index}` : ""}`}>
      ...
      <section className="journal">
        ...
        <div className="journal-grid">
          {articles.map((article, index) => (
            <Link href="/journal" key={article.title} className={`journal-card reveal${index ? ` d${index}` : ""}`}>
