...
export const Route = createFileRoute("/journal")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Writing from the Ardivia studio: design thinking, materials, heritage, and the craft of building enduring architecture." },
      { property: "og:title", content: "Journal — Ardivia" },
      { property: "og:description", content: "Writing from the studio — design, materials and craft." },
      { property: "og:image", content: "https://images.unsplash.com/photo-1600607687644-aac4c3eac7f4?w=1400&q=80" },
    ],
  }),
    ...
    <main>
      ...
      <section className="journal" style={{ paddingTop: 0 }}>
        <div className="journal-grid">
          {articles.map((a, i) => (
            <Link to="/journal" key={a.title} className={`journal-card reveal${i % 3 ? ` d${i % 3}` : ""}`}>
